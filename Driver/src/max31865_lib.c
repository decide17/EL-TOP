...
//
///*-------------------------------------------Для работы по spi-----------------------------------------------*/
//#define cs_set() GPIOB-> BSRR = (uint32_t) GPIO_PIN_1 << 16u; //CS_притягиваем к земле
//#define cs_reset() GPIOB ->BSRR = GPIO_PIN_1; //CS притягиваем к 3.3v
...
//  } else {
//    MAX31865_PT100_T = (double) 0.000000000270 * pow(PT100_Resistance, 5) - (double) 0.000000066245 * pow(PT100_Resistance, 4)
//        - (double) 0.000000184636 * pow(PT100_Resistance, 3) + (double) 0.002320232987 * pow(PT100_Resistance, 2) + (double) 2.229927824035 * PT100_Resistance
